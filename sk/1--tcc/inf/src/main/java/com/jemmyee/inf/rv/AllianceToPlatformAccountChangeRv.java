...
/**
 * 文件名称                ：AllianceToPlatformAccountChangeRv
 * 编写者                  : wanyixing
 * 编写日期                : 2017-9-8
 * 编写时间                : 02:00
 * 程序功能（类）描述       ：联盟向平台推送车辆绑定或账户充值信息，联盟平台返回参数
 */
public class AllianceToPlatformAccountChangeRv {
    ...
    @ApiModelProperty(value = "车辆入场时间号（格式：yyyyMMddHHmmss）")
    private String inTime;
    @ApiModelProperty(value = "收费截止时间1（格式：yyyyMMddHHmmss）")
    private String outTime1;
    @ApiModelProperty(value = "截止时间1费用")
    private Integer payFee1;
    @ApiModelProperty(value = "收费截止时间2（格式：yyyyMMddHHmmss）")
    private String outTime2;
    @ApiModelProperty(value = "截止时间2费用")
    private Integer payFee2;
    @ApiModelProperty(value = "收费截止3时间（格式：yyyyMMddHHmmss）")
    private String outTime3;
    @ApiModelProperty(value = "截止时间3费用")
    private Integer payFee3;
    @ApiModelProperty(value = "收费截止4时间（格式：yyyyMMddHHmmss）")
    private String outTime4;
    @ApiModelProperty(value = "截止时间4费用")
    private Integer payFee4;
    @ApiModelProperty(value = "收费截止5时间（格式：yyyyMMddHHmmss）")
    private String outTime5;
    @ApiModelProperty(value = "截止时间5费用")
    private Integer payFee5;
    @ApiModelProperty(value = "收费截止6时间（格式：yyyyMMddHHmmss）")
    private String outTime6;
    @ApiModelProperty(value = "截止时间6费用")
    private Integer payFee6;
    @ApiModelProperty(value = "收费截止7时间（格式：yyyyMMddHHmmss）")
    private String outTime7;
    @ApiModelProperty(value = "截止时间7费用")
    private Integer payFee7;
    @ApiModelProperty(value = "收费截止8时间（格式：yyyyMMddHHmmss）")
    private String outTime8;
    @ApiModelProperty(value = "截止时间8费用")
    private Integer payFee8;
    @ApiModelProperty(value = "收费截止时9间（格式：yyyyMMddHHmmss）")
    private String outTime9;
    @ApiModelProperty(value = "截止时间9费用")
    private Integer payFee9;
    @ApiModelProperty(value = "收费截止时间10（格式：yyyyMMddHHmmss）")
    private String outTime10;
    @ApiModelProperty(value = "截止时间10费用")
